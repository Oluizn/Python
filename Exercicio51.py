...
print(f"A probabilidade de sair a carta rei é de aproximadamente {probabilidade*100:.2f}%")
print(f"A probabilidade de sair a carta rei duas vezes seguidas, com a carta rei sendo reposta no baralho, é de aproximadamente {probabilidade_em_sequencia2*100:.2f}%")
print(f"A probabilidade de sair a carta rei quatro vezes seguidas, com a carta rei sendo reposta no baralho, é de aproximadamente {probabilidade_em_sequencia4*100:.4f}%")
print(f"A probabilidade de sair a carta rei 2 vezes seguidas, com a carta rei nao sendo reposta no baralho, é de aproximadamente {probabilidade_em_sequencia2_unreplaced*100:.2f}%")
print(f"A probabilidade de sair a carta rei 4 vezes seguidas, com a carta rei nao sendo reposta no baralho, é de aproximadamente {probabilidade_em_sequencia4_unreplaced*100:.4f}%")
